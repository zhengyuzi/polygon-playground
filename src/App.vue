...
<template>
  <div class="w-screen h-screen overflow-hidden">
    <div class="h-64px flex px-8 items-center justify-between border-b">
      <div class="font-serif text-2xl select-none cursor-pointer text-gray-600">
        <span class="text-blue-600">Polygon</span> Playground
      </div>
      <a
        target="_blank"
        href="https://github.com/zhengyuzi/polygon-playground"
